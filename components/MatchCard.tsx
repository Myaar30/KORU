...
const styles = StyleSheet.create({
  glassCardWrapper: { width: width * 0.9, height: height * 0.63, borderRadius: 22, overflow: 'hidden', shadowColor: COLORS.background, shadowOffset: { width: 0, height: 2 }, shadowOpacity: 1, shadowRadius: 15, elevation: 10 },
